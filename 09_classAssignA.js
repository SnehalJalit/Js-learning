...
let college1=new College("Shivaji College","Pune","A+","shivaji@123");
let college2=new College("MIT College","Mumbai","A+","mit@123");
let college3=new College("Datta Meghe College","Wardha","A+","Meghe@123");
let college4=new College("Sipna College","Akola","A+","abc@123");
college1.display();
college2.display();
college3.display();
college4.display();
